...
GUACAMOLE_DOWNLOAD_LINK="https://r.qunercloud.com/https://mirrors.ocf.berkeley.edu/apache/guacamole/1.5.3/source/guacamole-server-1.5.3.tar.gz"
...
function install_guacamole_web
{
	...
	cd $CurrentDir
	wget https://r.qunercloud.com/https://downloads.apache.org/guacamole/$GUACAMOLE_VERSION/binary/guacamole-$GUACAMOLE_VERSION.war
